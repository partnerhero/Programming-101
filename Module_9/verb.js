/*
    ...
    There are 3 main verbs:

    1. GET - used for GETting data
    2. POST - used for creating new data
    3. PUT - used for replacing data
    4. DELETE - yes, you're right

    Each of these verbs expects some sort of response. A GET verb would expect the data being requested, while 
    a POST or PUT verb just expects an indication that the request was successful.
